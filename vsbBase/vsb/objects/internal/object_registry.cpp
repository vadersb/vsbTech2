...
namespace vsb::internal
{
	namespace
	{
		constinit ObjectRegistry* g_pRegistry = nullptr;
	}
	...
	{
		VSB_ASSERT(g_pRegistry != nullptr, "ObjectRegistry instance is null!");
		VSB_CHECK_THREAD();
		return *g_pRegistry;
	}


	ObjectRegistry* ObjectRegistry::GetInstancePointer()
	{
		return g_pRegistry;
	}
